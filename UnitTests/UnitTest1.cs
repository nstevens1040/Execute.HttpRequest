namespace UnitTest1
{
    ...
    public class UnitTest1
    {
        ...
        public static string title_match = "JobSearch";
        public static string dluri = "https://raw.githubusercontent.com/nstevens1040/images/main/empty.vhdx";
        public static string title_check_uri = "https://beserver.nanick.org";
        ...
        public static string project_uri = "https://nstevens1040.github.io/Execute.HttpRequest/";
        [TestMethod]
        [DataRow("get")]
        [DataRow("post")]
        [DataRow("put")]
        ...
        {
            Execute.RetObject r = new Execute.RetObject();
            Assert.IsInstanceOfType(r, typeof(Execute.RetObject));
        }
        [TestMethod]
        ...
        public void TestGzip(string method)
        {
            ...
            RetObject r = Execute.HttpRequest.Send(
                "https://beserver.nanick.org/gzip",
                Utils.methods[method],
                h
            ); ;
